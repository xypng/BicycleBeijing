...
QuadTreeNodeData QuadTreeNodeDataForAMapPOI(Bicycle* poi)
{
    return QuadTreeNodeDataMake(poi.latitude, poi.longitude, (__bridge_retained void *)(poi));
}
...
{
    CLLocationDegrees minX = ((Bicycle *)pois[0]).latitude;
    CLLocationDegrees maxX = ((Bicycle *)pois[0]).latitude;
    
    CLLocationDegrees minY = ((Bicycle *)pois[0]).longitude;
    CLLocationDegrees maxY = ((Bicycle *)pois[0]).longitude;
